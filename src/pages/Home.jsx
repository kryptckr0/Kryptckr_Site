import { Activity, ArrowUpRight, ChevronDown, ShieldCheck } from 'lucide-react'
...
export default function Home() {
  return <>
    <section className="hero section">
      <div className="hero-backdrop" aria-hidden="true"><img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=2200&q=90" alt="" /></div>
      <div className="hero-shade" aria-hidden="true" />
      <div className="hero-copy">
        <div className="eyebrow"><span className="pulse"/> KRYPTCKR / TECHNICAL LAB / FR-2026</div>
        <h1>Les systèmes<br/><em>complexes.</em><br/><strong>Rendus clairs.</strong></h1>
        <p className="lead">Infrastructure · DevOps · Cloud · Cybersecurity</p>
        <p className="intro">Je transforme les problèmes techniques en systèmes fiables, observables et automatisables — une approche de terrain, documentée et construite pour durer.</p>
