...
export default function Home() {
  return <>
    ...
    <section className="section"><SectionLabel>01 / ABOUT</SectionLabel><div className="split"><div><p className="kicker">CURRENTLY</p><h2>Technicien aujourd'hui.<br/><span>DevOps demain.</span></h2></div><p>Mon terrain de jeu est l'infrastructure. Kryptckr documente ma progression à travers des projets, des labs, des expérimentations et des apprentissages orientés exploitation et automatisation.</p></div></section>
