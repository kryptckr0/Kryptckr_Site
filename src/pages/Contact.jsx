...
export default function Contact() {
  return <section className="page section contact-page">
    ...
    <div className="contact-links"><a className="contact-link" href="mailto:hello@kryptckr.fr"><Mail size={20}/><span>hello@kryptckr.fr</span><ArrowUpRight size={18}/></a><a className="contact-link" href="https://github.com/kryptckr0" target="_blank" rel="noreferrer"><Github size={20}/><span>github.com/kryptckr0</span><ArrowUpRight size={18}/></a></div>
  </section>
}
